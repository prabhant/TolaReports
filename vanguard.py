        ...
        html.Div([
                    ...
                    dcc.Graph(
                        ...
                        figure={
                            'data': [
                                go.Scatter(
                                    x = df_graph['id'],
                                    y = df_graph['total_estimated_budget'],
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Table(make_dash_table(df_price_perf), className="tiny-header")
                ], className=" twelve columns"),
            ...
            html.Div([
                ...
                html.Div([
                    ...
                    html.Table(make_dash_table(df_after_tax.head()), className="tiny-header")
                ], className=" twelve columns"),
